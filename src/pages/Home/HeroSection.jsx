...
//   return (
//     <>
//     <div className="w-full h-full flex justify-center items-center p-18 px-72">
//
...
export const HeroSection = () => {
  return (
    <>
      <div className="w-full h-[80vh] flex flex-col md:flex-row justify-center px-72 pt-32 ">
        <div className="space-y-6">
          ...
          <p className="text-[35px] text-b-1 font-bold">
            WE ARE <span>NEW SCHOOL</span> MARKETERS, <br /> DESIGNERS, WRITERS
            AND DEVLOPERS
          </p>
          ...
          <button className="flex  gap-2 justify-center items-center bg-b-2 rounded-4xl px-12 py-4 text-[14px] font-bold text-w-1">
      ...
      <div className="bg-secondary w-full h-[100vh]"></div>
